...
},{"lit-html":"SP/d","lit-html/lib/shady-render.js":"eBH8","./lib/updating-element.js":"fKvB","./lib/decorators.js":"4Fzp","lit-html/lit-html.js":"SP/d","./lib/css-tag.js":"ZFCR"}],"M9mv":[function(require,module,exports) {
"use strict";

var _litElement = require("lit-element");

// Import the LitElement base class and html helper function
class exitPopRender extends _litElement.LitElement {
  ...
  pop() {
    ...
    this.style.display = "flex"; // document.getElementsByClassName(`exitPop--background`)[0].classList.add('active');
  }

  pop_reRegister() {
    // start tracking mouse movement
    document.getElementsByTagName('html')[0].addEventListener('mouseleave', this.track.bind(this), {
      once: true
    });
  }
  ...
  render() {
    ...
    return _litElement.html`
      ...
      <div class="exitPop--background active exitPop--background_active">
          ${this.imgOnly == "false" ? _litElement.html`
              <div class="exitPop--container">
                <div class="exitPop--close" @click="${e => this.close()}"></div>
                <div class="exitPop--copy">
                  ${this.imgLink && this.imgUrl ? _litElement.html`
                      <a href="${this.imgLink}">
                        <img src="${this.imgUrl}">
                      </a>` : ''}
                  ${this.imgUrl && !this.imgLink ? _litElement.html`
                      <img src="${this.imgUrl}">` : ''}
                  <h1><strong>${this.h1}</strong></h1>
                  ${this.h2 ? _litElement.html`<h2>${this.h2}</h2>` : ''}
                  ${this.p1 ? _litElement.html`<p>${this.p1}</p>` : ''}
                  ${this.p2 ? _litElement.html`<p>${this.p2}</p>` : ''}
                  ${this.p3 ? _litElement.html`<p>${this.p3}</p>` : ''}
                </div>
                <div class="exitPop--buttons">
                  ${this.btnText1 ? _litElement.html`<div class="exitPop--button exitPop--close" @click="${e => this.close()}">${this.btnText1}</div>` : ''}
                  ${this.btnLink2 ? _litElement.html`<a class="exitPop--button" href="${this.btnLink2}">${this.btnText2}</a>` : ''}
                </div>
              </div>
            ` : _litElement.html`
...
},{"lit-element":"+bhx"}]},{},["M9mv"], null)
//# sourceMappingURL=exitPop.8feb4125.map